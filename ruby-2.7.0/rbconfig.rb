...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.7.0/-darwin23")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/vodka/.rvm/rubies/ruby-2.7.0")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/vodka/.rvm/rubies/ruby-2.7.0' '--with-openssl-dir=/opt/homebrew/opt/openssl@1.1'"
  ...
  CONFIG["arch"] = "-darwin23"
  CONFIG["sitearchincludedir"] = "$(includedir)/$(sitearch)"
  CONFIG["archincludedir"] = "$(includedir)/$(arch)"
  CONFIG["sitearchlibdir"] = "$(libdir)/$(sitearch)"
  CONFIG["archlibdir"] = "$(libdir)/$(arch)"
  CONFIG["libdirname"] = "libdir"
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/vodka/.rvm/rubies/ruby-2.7.0"
  ...
  CONFIG["target_cpu"] = ""
  CONFIG["target"] = "-apple-darwin23"
  CONFIG["host_os"] = "darwin23.5.0"
  CONFIG["host_vendor"] = "apple"
  CONFIG["host_cpu"] = "arm"
  CONFIG["host"] = "arm-apple-darwin23.5.0"
  CONFIG["RUBY_VERSION_NAME"] = "$(RUBY_BASE_NAME)-$(ruby_version)"
  CONFIG["RUBYW_BASE_NAME"] = "rubyw"
  CONFIG["RUBY_BASE_NAME"] = "ruby"
  CONFIG["build_os"] = "darwin23.5.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "arm"
  CONFIG["build"] = "arm-apple-darwin23.5.0"
