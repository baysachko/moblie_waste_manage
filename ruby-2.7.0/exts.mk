...
ECHO1 = $(V:1=@:)
ECHO = $(ECHO1:0=@echo)
extensions = ext/strscan/. ext/monitor/. ext/syslog/. ext/gdbm/. \
	     ext/pty/. ext/objspace/. ext/nkf/. ext/digest/. \
	     ...
	     ext/bigdecimal/. ext/-test-/arith_seq/extract/. \
	     ...
	     ext/-test-/wait_for_single_fd/. ext/fiddle/. ext/rubyvm/. \
	     ext/zlib/. ext/psych/. ext/cgi/escape/. ext/json/. \
	     ext/json/generator/. ext/json/parser/. ext/stringio/. \
	     ext/racc/cparse/. ext/fiber/. ext/sdbm/. \
	     ext/continuation/. ext/rbconfig/sizeof/. ext/dbm/. \
	     ext/fcntl/. ext/openssl/. ext/ripper/. ext/pathname/. \
	     ext/coverage/. ext/socket/.
EXTOBJS = dmyext.o
